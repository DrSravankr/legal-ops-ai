...
const services = [
  { icon: 'Home', title: 'Property Due Diligence', desc: 'Comprehensive title verification, encumbrance checks, and legal scrutiny reports for residential and commercial properties across South India and Maharashtra.' },
  { icon: 'Bank', title: 'Bank APF / Loan Reports', desc: 'Approved Project Finance (APF) and individual home loan legal scrutiny reports for all major banks and HFCs across India.' },
  { icon: 'Cert', title: 'Title Certification', desc: 'Independent title opinion and certification for sale, purchase, mortgage, and development transactions.' },
  { icon: 'Deal', title: 'JDA / GPA Advisory', desc: 'Joint Development Agreement and General Power of Attorney vetting, drafting, and registration services for developers and landowners.' },
  { icon: 'Law', title: 'Civil & Commercial Litigation', desc: 'Representation in property disputes, partition suits, injunctions, DRT proceedings and title suits before civil courts and High Court.' },
  { icon: 'Build', title: 'Developer Advisory', desc: 'End-to-end legal advisory for real estate developers - project land acquisition, RERA registration, approval NOCs, and buyer agreements.' },
]
        ...
        <div className="about-inner two-col-about">
          <div className="about-text-col">
            ...
            <div className="about-highlight-box">
              <span className="about-highlight-icon">Law</span>
          ...
          <div className="about-visual-col">
            <div className="about-card-stack">
              <div className="about-info-card primary">
                <div className="about-info-icon">Office</div>
              ...
              <div className="about-info-card secondary">
                <div className="about-info-icon">Location</div>
              ...
              <div className="about-info-card tertiary">
                <div className="about-info-icon">Award</div>
                <h4>Recognition</h4>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(260px,1fr))',gap:'.75rem',textAlign:'left'}}>
            {banks.map((b, i) => (
              <div key={i} style={{display:'flex',alignItems:'center',gap:'.6rem',padding:'.65rem 1rem',background: b.includes('...') ? '#f8f9ff' : '#f0fdf9',borderRadius:'8px',border:'1px solid #e0e4ef',fontSize:'.85rem',color: b.includes('...') ? '#888' : '#0d1b4b',fontStyle: b.includes('...') ? 'italic' : 'normal'}}>
                {!b.includes('...') && <span style={{color:'#1a7f74',fontWeight:700}}>OK</span>}
                {b}
              </div>
            ))}
          </div>
        ...
        <div className="about-inner two-col-about">
          <div className="about-text-col">
            ...
            <ul className="about-feature-list">
              <li>OK Reads scanned Kannada revenue records (RTC, MR, Tippani, Akarband)</li>
              <li>OK Extracts data from JDAs, GPAs, Sale Deeds, ECs automatically</li>
              <li>OK Generates bank-format Legal Scrutiny Reports in minutes</li>
              <li>OK Supports 10+ Indian languages with AI translation</li>
              <li>OK Full chain of title tracing and gap analysis</li>
              <li>OK Secure - documents encrypted end-to-end</li>
            </ul>
          ...
          <div className="about-tech-col">
            <div className="tech-card">
              ...
              <div className="infotech-logo-text" style={{display:'none'}}>âš¡ ANEESH INFOTECH</div>
